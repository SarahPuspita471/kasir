...
<body class="layout-shell bg-gray-50 text-gray-900 antialiased">
  ...
  <header class="header-blur sticky top-0 z-40">
    <div class="px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between">
      <div class="flex items-center gap-3">
        <button id="btnSidebar" class="lg:hidden inline-flex h-9 w-9 items-center justify-center rounded-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition">
  ...
  <div class="px-4 sm:px-6 lg:px-8 py-6 lg:grid lg:grid-cols-[260px_1fr] lg:gap-6">
    ...
    <aside id="sidebar"
           class="sidebar sidebar-hidden fixed inset-y-14 left-0 w-64 bg-white border-r border-gray-200 p-4 card
      ...
      <nav class="space-y-1 text-sm">
        ...
        <div class="mt-3">
          ...
          <a href="#" class="block rounded-md px-3 py-2 hover:bg-gray-100">📦 Produk</a>
